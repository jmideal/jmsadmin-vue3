<template>
   <div class="app-container">
      ...
      <el-table v-loading="loading" :data="roleList" @selection-change="handleSelectionChange">
         ...
         <el-table-column label="编号" prop="roleId" width="50" />
         ...
         <el-table-column label="操作" align="center" class-name="small-padding fixed-width" min-width="220">
            <template #default="scope">
              <el-button  size="small" type="success" icon="Edit" v-if="scope.row.roleId !== 1" @click="handleUpdate(scope.row)" v-hasPermi="['system:role:edit']">修改</el-button>
              <el-button  size="small" type="danger" icon="Delete" v-if="scope.row.roleId !== 1" @click="handleDelete(scope.row)" v-hasPermi="['system:role:remove']">删除</el-button>
              <el-button  size="small" type="primary" icon="CircleCheck" v-if="scope.row.roleId !== 1" @click="handleDataScope(scope.row)" v-hasPermi="['system:role:dataScopeEdit']">数据权限</el-button>
            </template>
         </el-table-column>
      </el-table>
         ...
         <el-form ref="roleRef" :model="form" :rules="rules" label-width="100px">
            ...
            <el-form-item label="菜单权限">
               ...
               <el-tree
                  ...
                  empty-text="加载中，请稍候"
                  :props="{ id: 'menuId', label: 'menuName', children: 'children' }"
               ></el-tree>
            </el-form-item>
...
function handleDataScope(row) {
  ...
  getRole(row.roleId).then(response => {
    ...
    dataScopeOptions.value = response.data.dataScopeList;
    nextTick(() => {
